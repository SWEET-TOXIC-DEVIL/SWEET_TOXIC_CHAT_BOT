...
from SWEET_TOXIC_CHAT import OWNER
...
DEV_OP = [
    ...
    [
        InlineKeyboardButton(
            text="✦ ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ ✦",
            url=f"https://t.me/{SWEET_TOXIC_CHAT.username}?startgroup=true",
        ),
    ],
    [
...
HELP_BUTN = [
    [
        InlineKeyboardButton(
            text="« ʜᴇʟᴘ »", url=f"https://t.me/{SWEET_TOXIC_CHAT.username}?start=help"
        ),
        InlineKeyboardButton(text="⦿ ᴄʟᴏsᴇ ⦿", callback_data="CLOSE"),
    ],
]
