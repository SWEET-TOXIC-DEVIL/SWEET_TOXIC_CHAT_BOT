...
from SWEET_TOXIC_CHAT.modules.helpers import CHATBOT_ON, is_admins


@SWEET_TOXIC_CHAT.on_cmd("chatbot", group_only=True)
...
async def chatbot_text(client: Client, message: Message):
    ...
    if not message.reply_to_message:
        SWEET_TOXICdb = MongoClient(MONGO_URL)
        SWEET_TOXIC = SWEET_TOXICdb["SWEET_TOXICDb"]["SWEET_TOXIC"]
        is_SWEET_TOXIC = SWEET_TOXIC.find_one({"chat_id": message.chat.id})
